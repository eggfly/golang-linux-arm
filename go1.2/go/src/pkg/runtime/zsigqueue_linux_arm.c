...
#line 34 "/usr/local/go/src/pkg/runtime/sigqueue.goc"
static struct { 
Note; 
...
#line 42 "/usr/local/go/src/pkg/runtime/sigqueue.goc"
enum { 
HASWAITER = 1 , 
HASSIGNAL = 2 , 
} ; 
#line 48 "/usr/local/go/src/pkg/runtime/sigqueue.goc"
bool 
runtime·sigsend ( int32 s ) 
{ 
uint32 bit , mask , old , new; 
#line 53 "/usr/local/go/src/pkg/runtime/sigqueue.goc"
...
#line 63 "/usr/local/go/src/pkg/runtime/sigqueue.goc"
for ( ;; ) { 
...
{
#line 85 "/usr/local/go/src/pkg/runtime/sigqueue.goc"
...
{
#line 135 "/usr/local/go/src/pkg/runtime/sigqueue.goc"
...
{
#line 152 "/usr/local/go/src/pkg/runtime/sigqueue.goc"
...
#line 160 "/usr/local/go/src/pkg/runtime/sigqueue.goc"
