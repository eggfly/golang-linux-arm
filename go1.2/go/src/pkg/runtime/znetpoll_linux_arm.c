...
#line 24 "/usr/local/go/src/pkg/runtime/netpoll.goc"
struct PollDesc 
{ 
PollDesc* link; 
Lock; 
...
#line 39 "/usr/local/go/src/pkg/runtime/netpoll.goc"
static struct 
{ 
Lock; 
PollDesc* first; 
#line 48 "/usr/local/go/src/pkg/runtime/netpoll.goc"
} pollcache; 
#line 50 "/usr/local/go/src/pkg/runtime/netpoll.goc"
...
#line 58 "/usr/local/go/src/pkg/runtime/netpoll.goc"
...
{
#line 62 "/usr/local/go/src/pkg/runtime/netpoll.goc"
...
{
#line 66 "/usr/local/go/src/pkg/runtime/netpoll.goc"
...
{
#line 85 "/usr/local/go/src/pkg/runtime/netpoll.goc"
...
{
#line 99 "/usr/local/go/src/pkg/runtime/netpoll.goc"
...
{
#line 112 "/usr/local/go/src/pkg/runtime/netpoll.goc"
...
{
#line 128 "/usr/local/go/src/pkg/runtime/netpoll.goc"
...
{
#line 136 "/usr/local/go/src/pkg/runtime/netpoll.goc"
...
{
#line 200 "/usr/local/go/src/pkg/runtime/netpoll.goc"
...
#line 225 "/usr/local/go/src/pkg/runtime/netpoll.goc"
uintptr 
runtime·netpollfd ( PollDesc *pd ) 
{ 
return pd->fd; 
} 
#line 232 "/usr/local/go/src/pkg/runtime/netpoll.goc"
void 
runtime·netpollready ( G **gpp , PollDesc *pd , int32 mode ) 
{ 
G *rg , *wg; 
#line 237 "/usr/local/go/src/pkg/runtime/netpoll.goc"
rg = wg = nil; 
runtime·lock ( pd ) ; 
if ( mode == 'r' || mode == 'r' +'w' ) 
...
#line 254 "/usr/local/go/src/pkg/runtime/netpoll.goc"
static intgo 
...
#line 265 "/usr/local/go/src/pkg/runtime/netpoll.goc"
static bool 
netpollblock ( PollDesc *pd , int32 mode ) 
{ 
G **gpp; 
#line 270 "/usr/local/go/src/pkg/runtime/netpoll.goc"
gpp = &pd->rg; 
if ( mode == 'w' ) 
gpp = &pd->wg; 
if ( *gpp == READY ) { 
...
#line 287 "/usr/local/go/src/pkg/runtime/netpoll.goc"
static G* 
netpollunblock ( PollDesc *pd , int32 mode , bool ioready ) 
{ 
G **gpp , *old; 
#line 292 "/usr/local/go/src/pkg/runtime/netpoll.goc"
gpp = &pd->rg; 
if ( mode == 'w' ) 
gpp = &pd->wg; 
if ( *gpp == READY ) 
return nil; 
if ( *gpp == nil ) { 
#line 300 "/usr/local/go/src/pkg/runtime/netpoll.goc"
if ( ioready ) 
*gpp = READY; 
return nil; 
} 
old = *gpp; 
#line 306 "/usr/local/go/src/pkg/runtime/netpoll.goc"
old->param = ( void* ) ioready; 
*gpp = nil; 
return old; 
} 
#line 311 "/usr/local/go/src/pkg/runtime/netpoll.goc"
static void 
...
uint32 seq; 
G *rg , *wg; 
#line 318 "/usr/local/go/src/pkg/runtime/netpoll.goc"
USED ( now ) ; 
pd = ( PollDesc* ) arg.data; 
#line 322 "/usr/local/go/src/pkg/runtime/netpoll.goc"
seq = ( uintptr ) arg.type; 
rg = wg = nil; 
runtime·lock ( pd ) ; 
if ( seq != pd->seq ) { 
#line 327 "/usr/local/go/src/pkg/runtime/netpoll.goc"
runtime·unlock ( pd ) ; 
return; 
} 
if ( read ) { 
...
#line 351 "/usr/local/go/src/pkg/runtime/netpoll.goc"
static void 
deadline ( int64 now , Eface arg ) 
{ 
deadlineimpl ( now , arg , true , true ) ; 
} 
#line 357 "/usr/local/go/src/pkg/runtime/netpoll.goc"
static void 
readDeadline ( int64 now , Eface arg ) 
{ 
deadlineimpl ( now , arg , true , false ) ; 
} 
#line 363 "/usr/local/go/src/pkg/runtime/netpoll.goc"
static void 
writeDeadline ( int64 now , Eface arg ) 
{ 
deadlineimpl ( now , arg , false , true ) ; 
} 
#line 369 "/usr/local/go/src/pkg/runtime/netpoll.goc"
static PollDesc* 
allocPollDesc ( void ) 
{ 
PollDesc *pd; 
uint32 i , n; 
#line 375 "/usr/local/go/src/pkg/runtime/netpoll.goc"
runtime·lock ( &pollcache ) ; 
if ( pollcache.first == nil ) { 
n = PageSize/sizeof ( *pd ) ; 
if ( n == 0 ) 
n = 1; 
#line 382 "/usr/local/go/src/pkg/runtime/netpoll.goc"
